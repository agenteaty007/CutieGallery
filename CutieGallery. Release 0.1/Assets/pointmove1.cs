...
public class pointmove1 : MonoBehaviour
{
	...
	{
		Frame frame = controller.Frame(); // HERE
		//FingerList fingers = frame.Fingers; /// HERE
		HandList hands = frame.Hands; //HERE


		//int countFingers = fingers.Count; //HERE
		//int fingerCount1 = frame.Fingers.Count; //HERE
		...
		bool moveForward = Input.GetKey (KeyCode.W) || Input.GetKey (KeyCode.UpArrow);// || countFingers;
